...
- **Missing IP Logic**: `service_name.sh` did not call `assign_project_ip` during installation.
...
All services have been updated to the "One IP per Project" architecture.

| Service | Script (.sh) | Compose (YAML) | Status |
| :--- | :---: | :---: | :---: |
| **Arcane** | ✅ | ✅ | **Completed** |
| **n8n** | ✅ | ✅ | **Completed** |
| **Caddy Proxy + Manager** | ✅ | ✅ | **Completed** |
| **Windmill** | ✅ | ✅ | **Completed** |
| **Supabase** | ✅ | ✅ | **Completed** |
| **Wallos** | ✅ | ✅ | **Completed** |
| **Airtable** | ✅ | ✅ | **Completed** |
