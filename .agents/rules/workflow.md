...
- **Features**: Comparativa (Tabla: Pros/Cons/Risks/Compl) -> Recomendación -> Doc en `/Features/` o `/Design/`.
- **Refactor**: Justificar, definir alcance y plan incremental.
- **Estilo**: Lenguaje claro, Español (salvo regla global), títulos cortos.
=======
---
trigger: always_on
---
