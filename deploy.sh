...
<<<<<<< HEAD
    ...
    "AnyType|projects/anytype/anytype.sh|/opt/anytype|any-sync-coordinator|Self-hosted local-first platform|Nodes: {IP}:1001-1004"
=======
    ""Airtable|projects/airtable/airtable.sh|/opt/airtable|airtable-gateway|Advanced no-code database (Airtable-like)|Servicio: {IP}:8081""
...
>>>>>>> f85d02191b770a620cc84728dde673114ce69755
